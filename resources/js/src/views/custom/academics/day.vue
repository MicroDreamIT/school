                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-md-8">
                            <ow-data-table :headers="tableHeader"
                                           :tableHeader="'Days List'"
                                           :suggestText="'Days Record list on table. Filter Days using the filter.\n'"
                                           :url="url"
                                           :noDataMessage="'No Day data found. Please Days filter to show.'"
                                           :hasSearch="true"
                                           :has-multiple="true"
                                           :has-pagination="true"
                                           :main-item="mainItem"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            deleteItems() {
                this.$http.get('/json/day/' + this.deleteItem + '/delete').then(res => {
                    this.getData();
                    this.$root.notification.status = res.data[0];
                    this.$root.notification.message = res.data[1]
                })
