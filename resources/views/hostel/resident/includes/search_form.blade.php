        ...
        <div class="panel-collapse collapse" id="collapseOne" aria-expanded="false" style="height: 0px;">
            <div class="panel-body">
                ...
                <div class="clearfix form-horizontal">
                    <div class="row">
                        {!! Form::label('user_type', 'Type', ['class' => 'col-md-1 control-label']) !!}
                        <div class="col-md-2">
                            {!! Form::select('user_type', ["0"=>"Select Type","1"=>"Student","2"=>"Staff"], null, ['class' => 'form-control']) !!}
                        </div>

                        {!! Form::label('reg_no', 'REG No.', ['class' => 'col-md-1 control-label']) !!}
                        <div class="col-md-2">
                            {!! Form::text('reg_no', null, ["placeholder" => "", "class" => "form-control border-form","autofocus"]) !!}
                        </div>


                        {!! Form::label('hostel', 'Hostel', ['class' => 'col-md-2 control-label']) !!}
                        <div class="col-md-4">
