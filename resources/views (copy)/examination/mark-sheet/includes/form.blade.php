...
<div class="form-horizontal ">
    <div class="clearfix">
        <div class="container">
        <div class="row">
            {!! Form::label('years_id', 'Year', ['class' => 'col-md-1 control-label']) !!}
            <div class="col-md-2">
            ...
            {!! Form::label('months_id', 'Month', ['class' => 'col-md-1 control-label']) !!}
            <div class="col-md-2">
            ...
            {!! Form::label('exams_id', 'Exam', ['class' => 'col-md-1 control-label']) !!}
            <div class="col-md-2">
        ...
        <div class="row">
            ...
            <label class="col-md-2 control-label mt-2">Faculty/Class</label>
            ...
            <label class="col-md-2 control-label mt-2">Sem./Sec.</label>
            <div class="col-md-3 mt-2">
