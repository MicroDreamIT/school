  <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item {!! request()->is('/')?'active':'' !!}"><a href="{{ route('home') }}"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span></a>
        ...
        @ability('super-admin','account')
           ...
           <li class=" nav-item {!! request()->is('account/*')?'active open':'' !!}"><a href="#"><i class="menu-icon fa fa-calculator" aria-hidden="true"></i><span class="menu-title" data-i18n="Student & Staff">Account</span></a>
                    <ul class="menu-content">
                         ...
                         <li class="{!! request()->is('account/payroll*')?'active open':'' !!}"><a href="#"><i class="feather icon-circle"></i><span class="menu-item" >Payroll</span></a>
                            <ul class="menu-content">
                        ...
                        <li class="{!! request()->is('account/transaction*')?'active':'' !!}"><a href="#"><i class="feather icon-circle"></i><span class="menu-item" >Ledger & Transaction</span></a>
                            <ul class="menu-content">
                        ...
                        <li class="{!! request()->is('account/bank*')?'active':'' !!}"><a href="#"><i class="feather icon-circle"></i><span class="menu-item" > Bank</span></a>
                            <ul class="menu-content">
