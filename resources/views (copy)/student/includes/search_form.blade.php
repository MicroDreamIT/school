<div class="row">
    ...
    <div class=" col-sm-3">
        <div class="input-group ">
            {!! Form::text('reg_start_date', null, ["placeholder" => "YYYY-MM-DD", "class" => "form-control pickadate picker__input picker__input--active", "data-date-format" => "yyyy-mm-dd"]) !!}
            <span class="input-group-addon">
                                    <i class="fa fa-exchange"></i>
                                </span>
            {!! Form::text('reg_end_date', null, ["placeholder" => "YYYY-MM-DD", "class" => "form-control pickadate picker__input picker__input--active", "data-date-format" => "yyyy-mm-dd"]) !!}
