                        ...
                        <?php if(isset($data['student-batch']) && $data['student-batch']->count() > 0): ?>
                            ...
                            <?php $__currentLoopData = $data['student-batch']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student_batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="hidden-480 ">
                                        <div class="btn-group">
                                            <button data-toggle="dropdown" class="btn btn-primary btn-sm dropdown-toggle <?php echo e($student_batch->status == 'active'?"btn-info":"btn-warning", false); ?>" >
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            <a class="btn btn-success btn-sm" href="<?php echo e(route($base_route.'.edit', ['id' => $student_batch->id]), false); ?>">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>

                                            <a href="<?php echo e(route($base_route.'.delete', ['id' => $student_batch->id]), false); ?>" class="btn btn-danger btn-sm">
                                        ...
                                        <!--<div class="hidden-md hidden-lg">
                                            <div class="inline pos-rel">
                                                ...
                                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                    <li>
                                                        <a href="<?php echo e(route($base_route.'.edit', ['id' => $student_batch->id]), false); ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                            <span class="green">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo e(route($base_route.'.delete', ['id' => $student_batch->id]), false); ?>" class="tooltip-error bootbox-confirm" data-rel="tooltip" title="Delete">
                                                            <span class="red ">
        ...
        </div><?php /**PATH /home/viholddep/public_html/edu/resources/views/academic/student-batch/includes/table.blade.php ENDPATH**/ ?>