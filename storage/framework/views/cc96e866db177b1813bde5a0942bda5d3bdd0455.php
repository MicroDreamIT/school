    ...
    <div class="col-md-12">
        ...
        <div class="table-responsive">
            <table  class="table table-striped dataex-html5-selectors">
                ...
                <?php if(isset($data['subject_attendance']) && $data['subject_attendance']->count() > 0): ?>
                    <?php ($i=1); ?>
                    <?php $__currentLoopData = $data['subject_attendance']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                           ...
                           <td><?php echo e(ViewHelper::getYearById($attendance->years_id), false); ?> </td>
                            ...
                            <td><?php echo e(ViewHelper::getSubjectById($attendance->subjects_id), false); ?> </td>
                            <td>
                                <?php echo e(($attendance->attendance_type == 1)?"Theory":"Practical", false); ?>
...
</div><?php /**PATH /home/viholddep/public_html/edu/resources/views/user-student/attendance/includes/attendance/subject-attendance.blade.php ENDPATH**/ ?>