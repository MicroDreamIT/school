                ...
                @if (isset($data['faculty']) && $data['faculty']->count() > 0)
                    ...
                    @foreach($data['faculty'] as $faculty)
                        <tr>
                            ...
                            <td class="hidden-480 ">
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn btn-primary btn-sm dropdown-toggle {{ $faculty->status == 'active'?"btn-info":"btn-warning" }}" >
                            ...
                            <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <a class="btn-success btn-sm btn green" href="{{ route($base_route.'.edit', ['id' => $faculty->id]) }}">
                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                    </a>

                                    <a href="{{ route($base_route.'.delete', ['id' => $faculty->id]) }}" class="btn green btn-danger btn-sm red bootbox-confirm">
