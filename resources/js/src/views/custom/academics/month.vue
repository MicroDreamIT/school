                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-md-8">
                            <ow-data-table :headers="tableHeader"
                                           :tableHeader="'Months List'"
                                           :suggestText="'Months Record list on table. Filter Months using the filter.\n'"
                                           :url="url"
                                           :noDataMessage="'No Month data found. Please Months filter to show.'"
                                           :hasSearch="true"
                                           :has-multiple="true"
                                           :has-pagination="true"
                                           :main-item="mainItem"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            editItems(id) {
                this.$router.push({name: 'monthEdit', params: {id: id}})
            },
            deletePopModal(id) {
                this.deleteItem = id;
                this.deletePop = true
