    ...
    <div>
        <div class="row ">
            ...
            <vs-card>
                <div class="row">
                    <div class="col-md-4">
                        <div> Create Faculty/Level/Class</div>
                        <div class="d-flex justify-content-between">
                            <p>Faculty/Class</p>
                            <vs-input></vs-input>
                        </div>
                        <div class="d-flex justify-content-between">
                            <p>Faculty/ClassCode</p>
                            <vs-input></vs-input>
                        </div>
                        <div class="d-flex justify-content-between">
                            <vs-checkbox>1</vs-checkbox>
                            <vs-checkbox>3</vs-checkbox>
                        </div>
                    ...
                    <div class="col-md-8">
                        <h4 class="header large lighter blue">
                            <i class="fa fa-list" aria-hidden="true"></i>&nbsp; Faculty/Level/Class List
                            List</h4>
