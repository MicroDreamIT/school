<template>
    <div>
        <div class="row ">
            <div class="col-md-12">
                     <h2 class="pageTitle">Attendance Status Manage</h2>
           ...
           <div class="col-md-12">
               <vs-card>
                   <div class="row p-4">
                       <div class="col-md-6">
                           <h4> Create Attendance Status</h4><br>
                           <div class="form-group row">
                               <label class="col-sm-3">Attendance Status</label>
                               <vs-input class="col-sm-9"></vs-input>
                           </div>
                           <div class="form-group row">
                               <label class="col-sm-3">Display Color</label>
                               <vs-input class="col-sm-9"></vs-input>
                           </div>
