...
<?php $__env->startSection('content'); ?>
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Faculty/Level/Class Manager</h2>
 ...
 <?php if(isset($data['row']) && $data['row']->count() > 0): ?>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_new', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/viholddep/public_html/edu/resources/views/academic/faculty/index.blade.php ENDPATH**/ ?>