...
<div class="row">
    {!! Form::label('driver', 'Driver', ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-4">
    ...
    {!! Form::label('host', 'Host', ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-4">
...
<br>
<div class="row">
    {!! Form::label('port', 'Port', ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-4">
    ...
    {!! Form::label('encryption', 'Encryption', ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-4">
...
<br>
<div class="row">
    {!! Form::label('user_name', 'User Name', ['placeholder'=>'e.g.SMTP','class' => 'col-md-2 control-label']) !!}
    <div class="col-md-4">
