    ...
    <div>
        <div class="row">
            <div class="col-md-12 mb-2">
                <h2 class="pageTitle">Exam Mark Ledger Manager</h2>
            </div>
            <div class="col-md-12">
                <div class="row mx-0">
                    <router-link :to="'/exam'">
            ...
            <div class="col-md-12">
                <vs-card class="row">
                    <div class="col-md-12">
                        ...
                        <router-link :to="'/exam/mark-ledger/add'">
                            <vs-button type="filled" class="smBtn">
                                <i class="fa fa-list" aria-hidden="true"></i>
                                Prepare Ledger/Edit
                            </vs-button>
                    ...
                    <div class="col-md-12 ">
                        <h4 class="header large lighter blue">
                            <i class="fa fa-list" aria-hidden="true"></i>
                            Exam Mark Ledger List
                        </h4>

                        <div class="table-header">
                            Exam Mark Ledger Record list on table. Filter Exam Mark Ledger using the filter.
                        </div>
                    </div>
                    <div class="col-md-12 ">
                        <vs-table
