            ...
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false">
                    <h3 class="header large lighter blue btn btn-primary">
                        ...
                        Filter <?php echo e($panel, false); ?> History
            ...
            <div class="panel-body">
                ...
                <div class="clearfix form-horizontal">
                    <div class="row">
                        ...
                        <?php echo Form::label('history_type', 'History Type', ['class' => 'col-sm-2 control-label']); ?>
                    ...
                    <div class="row">
                        ...
                        <?php echo Form::label('hostel', 'Hostel', ['class' => 'col-sm-1 control-label']); ?>
...
</div><?php /**PATH /home/viholddep/public_html/edu/resources/views/hostel/resident/history/includes/form.blade.php ENDPATH**/ ?>