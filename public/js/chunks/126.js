            ...
            _c("vs-card", [
              _c("div", { staticClass: "row p-2" }, [
                _c("h4", { staticClass: "ml-4" }, [
                  _vm._v("Student Documents Manager")
                ]),
                _vm._v(" "),
                      ...
                      _c(
                        ...
                        [
                          _c("vs-input", {
                            staticClass: "w-100",
                            model: {
                              value: _vm.document.reg_no,
                              callback: function($$v) {
                                _vm.$set(_vm.document, "reg_no", $$v)
                              },
                              expression: "document.reg_no"
                            }
                          })
                        ],
                        1
                      ...
                      _c(
                        ...
                        [
                          _c("vs-input", {
                            ...
                            attrs: { type: "file" },
                            model: {
                              value: _vm.document.document_file,
                              callback: function($$v) {
                                _vm.$set(_vm.document, "document_file", $$v)
                              },
                              expression: "document.document_file"
                            }
                          })
                        ],
                        1
                    ...
                    [
                      ...
                      _c("ow-data-table", {
                        attrs: {
                          ...
                          url: "/json/student/",
                          noDataMessage:
                            "No Student Document data found. Please Filter Student Document to show.",
                          "has-search": true,
                          "has-multiple": true,
                          "has-pagination": true,
                          suggestText:
