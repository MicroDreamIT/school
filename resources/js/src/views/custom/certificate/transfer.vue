<template>
	<div>
		<div class="row ">
			<div class="col-md-12">
				<h2 class="pageTitle">Transfer Certificate Manager
				</h2>
				<div class="p-2">
					<router-link :to="'/'">
					...
					<div class="p-2">
						<router-link :to="'/account/fees'">
							<vs-button type="filled" class="smBtn">
								...
								Transfer Certificate Detail
							</vs-button>
						</router-link>
					</div>
					<hr class="own-hr">
					<student-table :headers="studentHeader"
					               :tableHeader="'Transfer Certificate List'"
					               :suggestText="'Transfer Certificate Record list on table. Filter Transfer Certificate using the filter.'"
					               :url="'/json/student/'"
