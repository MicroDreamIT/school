...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(url('/'), false); ?>/includes_new/app-assets/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(url('/'), false); ?>/includes_new/app-assets/images/ico/favicon.ico">
    <link href="https://fonts.googleapis.com/css?family=Montserrat:300,400,500,600" rel="stylesheet">
  <link rel="stylesheet" href="<?php echo e(url('/'), false); ?>/assets/css/select2.min.css" />
    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/'), false); ?>/includes_new/app-assets/vendors/css/vendors.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/'), false); ?>/includes_new/app-assets/vendors/css/tables/datatable/datatables.min.css">
    <!-- END: Vendor CSS-->
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo e(url('/'), false); ?>/includes_new/app-assets/vendors/css/pickers/pickadate/pickadate.css">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/'), false); ?>/includes_new/assets/css/style.css">
     <link href="<?php echo e(url('/'), false); ?>/includes_new/app-assets/css/toastr.min.css" rel="stylesheet">
    <!-- END: Custom CSS-->
<style type="text/css">
    .breadcrumb{display: none;}

   table a.btn.btn-danger,table a.btn.btn-primary,table a.btn.btn-success{
    width: 32px;
    height: 32px;
    padding: 5px 0px;
...
.content-header-right .breadcrum-right{
    display: none !important;
}


</style>
</head><?php /**PATH /home/viholddep/public_html/edu/resources/views/user-student/layouts/includes_new/header.blade.php ENDPATH**/ ?>