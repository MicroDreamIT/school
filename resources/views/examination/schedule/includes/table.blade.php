                ...
                @if (isset($data['schedule_exams']) && $data['schedule_exams']->count() > 0)
                    ...
                    @foreach($data['schedule_exams'] as $exam)
                        <tr>
                            ...
                            <td class="hidden-480 ">
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn btn-primary btn-sm dropdown-toggle {{ $exam->publish_status == '1'?"btn-info":"btn-warning" }}" >
                            ...
                            <td class="hidden-480 ">
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn btn-primary btn-sm dropdown-toggle {{ $exam->status == 'active'?"btn-info":"btn-warning" }}" >
