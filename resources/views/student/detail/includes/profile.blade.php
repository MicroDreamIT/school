...
.profile-users .memberdiv .tools>a {
    ...
    <div class="col-xs-12 col-sm-9 col-print-9">
        ...
        <div class="label label-info label-xlg arrowed-in arrowed-right arrowed mt-1 mb-1 btn btn-warning btn-sm">{{ $data['student']->first_name.' '.
...
<div class="row">
    <div class="space-6"></div>
    <div class="label label-info label-xlg arrowed-in arrowed-right arrowed mt-1 mb-1 btn btn-primary btn-sm">Permanent Address</div>
    <div class="space-6"></div>
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
    ...
    <div class="space-6"></div>
    <div class="label label-info label-xlg arrowed-in arrowed-right arrowed mt-1 mb-1 btn btn-primary btn-sm">Temporary Address</div>
    <div class="space-6"></div>
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
    ...
    <div class="space-6"></div>
    <div class="label label-info label-xlg arrowed-in arrowed-right arrowed mt-1 mb-1 btn btn-primary btn-sm">Parential Info</div>
    ...
    <div class="label mt-1 mb-1 label-info label-xlg arrowed-in arrowed-right arrowed mt-1 mb-1 btn btn-primary btn-sm">Guardian Info</div>
    <br/>
    <div class="space-6"></div>
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
...
<div class="row hidden-print">
    ...
    <div class="col-xs-12 col-sm-3 center">
        <div>
            <div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
               <br/>
               <span class="btn btn-primary btn-sm">Guardian</span>
    ...
    <div class="col-xs-12 col-sm-3 center">
        <div>
            <div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
               <br/>
               <span class="btn btn-primary btn-sm">Father</span>
    ...
    <div class="col-xs-12 col-sm-3 center">
        <div>
            <div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
               <br/>
               <span class="btn btn-primary btn-sm">Mother</span>
