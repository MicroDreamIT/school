                                    ...
                                    <td class="hidden-480 ">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li style="margin:5px">
                                                    <a href="{{ route($base_route.'.active', ['id' => $note->id]) }}"><i class="fa fa-check" aria-hidden="true"></i> Active</a>
                                                </li>
<hr/>
                                                <li style="margin:5px">
                                                    <a href="{{ route($base_route.'.in-active', ['id' => $note->id]) }}"><i class="fa fa-remove" aria-hidden="true"></i> In Active</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
