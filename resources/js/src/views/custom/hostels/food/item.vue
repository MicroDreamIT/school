<template>
    <div>
        <div class="row ">
            <div class="col-md-12">
                <h2 class="pageTitle">Food Item Manager</h2>
                <div class="mb-2">
                ...
                <div class="row mx-0">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="d-flex justify-content-between flex-wrap">
                            ...
                            <vs-textarea type="file" class="flex-2" height="100px"></vs-textarea>
                        </div>
                        <div class="d-flex justify-content-between flex-wrap">
                            <p class="flex-1">Image</p>
                            <vs-input class="flex-2 " type="file"></vs-input>
                        </div>
