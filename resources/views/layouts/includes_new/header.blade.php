...
<head>
  ...
  <link rel="stylesheet" href="{{url('/')}}/assets/css/select2.min.css" />
    ...
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/includes_new/app-assets/vendors/css/tables/datatable/datatables.min.css">
    <!-- END: Vendor CSS-->
 ...
 <link rel="stylesheet" type="text/css" href="{{url('/')}}/includes_new/app-assets/vendors/css/pickers/pickadate/pickadate.css">
    ...
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/includes_new/assets/css/style.css">
     <link href="{{url('/')}}/includes_new/app-assets/css/toastr.min.css" rel="stylesheet">
    <!-- END: Custom CSS-->
<style type="text/css">
