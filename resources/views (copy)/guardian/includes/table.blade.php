                ...
                @if (isset($data['guardian']) && $data['guardian']->count() > 0)
                    ...
                    <button data-toggle="dropdown" class="btn btn-primary btn-minier dropdown-toggle {{ $guardian->status == 'active'?"btn-info":"btn-warning" }}" >
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            &nbsp;&nbsp; <a href="{{ route($base_route.'.active', ['id' => $guardian->id]) }}" title="Active"><i class="fa fa-check" aria-hidden="true"> Active</i></a>
                                        </li>
<hr/>
                                        <li>
                                           &nbsp;&nbsp; <a href="{{ route($base_route.'.in-active', ['id' => $guardian->id]) }}" title="In-Active"><i class="fa fa-remove" aria-hidden="true"></i> In Active</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
