                        ...
                        @if (isset($data['days']) && $data['days']->count() > 0)
                            ...
                            @foreach($data['days'] as $day)
                                <tr>
                                    ...
                                    <td class="hidden-480 ">
                                        <div class="btn-group">
                                            <button data-toggle="dropdown" class="btn btn-primary btn-sm dropdown-toggle {{ $day->status == 'active'?"btn-info":"btn-warning" }}" >
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            <a class="btn-primary btn-sm btn" href="{{ route($base_route.'.edit', ['id' => $day->id]) }}" >
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>

                                            <a href="{{ route($base_route.'.delete', ['id' => $day->id]) }}" class="btn-danger btn-sm btn">
