                    ...
                    <div class="form-group">
                        ...
                        <div class=" col-sm-4">
                            <div class="input-group ">
                                {!! Form::text('start_date', null, ["placeholder" => "YYYY-MM-DD", "class" => "input-sm form-control border-form input-mask-date date-picker pickadate picker__input picker__input--active", "data-date-format" => "yyyy-mm-dd"]) !!}
