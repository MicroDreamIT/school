                        ...
                        <tr>
                            ...
                            <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <a href="{{ route($base_route.'.print', ['id' => encrypt($student->id)]) }}" class="btn btn-primary btn-sm" target="_blank">
                                    ...
                                    <a href="{{ route($base_route.'.delete', ['id' => $student->id]) }}" class="btn btn-danger btn-sm bootbox-confirm" target="_blank" >
