...
<head>
    ...
    <title>Error 403 - Vuexy - Bootstrap HTML admin template</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/'), false); ?>/includes_new/app-assets/css/pages/error.css">
    <!-- END: Page CSS-->
                        ...
                        <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                            <div class="card-content">
                                <div class="card-body text-center">
                                    <img src="<?php echo e(url('/'), false); ?>/includes_new/app-assets/images/pages/500.png" class="img-fluid align-self-center" alt="branding logo">
                                    <h1 class="font-large-2 mt-1 mb-0">403 forbidden error</h1>
                                    <p class="p-3">
...
</html><?php /**PATH /home/viholddep/public_html/edu/resources/views/errors/403.blade.php ENDPATH**/ ?>