...
<div class="tabbable">
    <ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
      ...
      {{--  <li>
            <a data-toggle="tab" href="#academicInfo" class="btn-primary btn-sm"><i class="fa fa-certificate bigger-110"></i> Academic Info</a>
        </li>
        <li class="">
            <a data-toggle="tab" href="#profileimage" class="btn-primary btn-sm"><i class="fa fa-image bigger-110"></i> Profile Images</a>
        </li>--}}
    </ul>
