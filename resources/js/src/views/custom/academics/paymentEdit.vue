                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-md-8">
                            <ow-data-table :headers="tableHeader"
                                           ...
                                           :url="url"
                                           :noDataMessage="'No Payment Method data found. Please Payment Method  filter to show.'"
                                           :hasSearch="true"
                                           :has-multiple="true"
                                           :has-pagination="true"
                                           :main-item="mainItem"
    ...
    export default {
        ...
        data() {
            return {
                searchData: {},
                tableHeader: [
                    {name: 'Payment Method', sort_key: 'title'},
                    {name: 'Status'},
                    {name: 'Action'},
                ],
                title: '',
        ...
        methods: {
            ...
            changeStatus(id, status) {
                ...
                let url = '/json/payment-method/' + id + '/' + stat;
            ...
            deleteItems() {
                this.$http.get('/json/payment-method/' + this.deleteItem + '/delete').then(res => {
                    this.getData();
                    this.$root.notification.status = res.data[0];
                    this.$root.notification.message = res.data[1]
                })
