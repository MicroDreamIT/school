                    ...
                    <?php if(isset($data['student']) && $data['student']->count() > 0): ?>
                        ...
                        <?php $__currentLoopData = $data['student']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($student->year_of_study, false); ?></td>
                                <td><?php echo e($student->percentage_of_attendance, false); ?></td>
                                <td>
...
</div><?php /**PATH /home/viholddep/public_html/edu/resources/views/certificate/attendance/includes/table.blade.php ENDPATH**/ ?>