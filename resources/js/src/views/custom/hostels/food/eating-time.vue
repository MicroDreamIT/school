<template>
    <div>
        <div class="row ">
            <div class="col-md-12">
                <h2 class="pageTitle">Eating Time Manager</h2>
                <div class="mb-2">
           ...
           <div class="col-md-12">
               <vs-card>
                   <div class="row p-4">
                       <div class="col-md-4">
                           <h4>Create Eating Time</h4><br>
                           <div class="forn-group row mb-3">
                       ...
                       <div class="col-md-8">
                           <h4 class="header large lighter blue">
                               <i class="fa fa-list" aria-hidden="true"></i>&nbsp;Eating Time List
                           </h4>
                           ...
                           <data-table :headers="tableHeader"
                                       :url="'/student'"
                                       :no-data-message="'No Eating Time data found. Please Filter Eating Time to show.'"
