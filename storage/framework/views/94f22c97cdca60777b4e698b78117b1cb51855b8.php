                ...
                <section id="basic-datatable">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xs-12">
                         ...
                         <div class="col-md-12 col-xs-12">
                            <br/>
                            <?php echo $__env->make('certificate.generate.includes.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                          

                        <div class="col-md-12 col-xs-12 m-2">
                           <?php echo $__env->make('certificate.generate.includes.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div><!-- /.col -->
...
<?php $__env->startSection('js'); ?>
  <!-- inline scripts related to this page -->
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_new', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/viholddep/public_html/edu/resources/views/certificate/generate/index.blade.php ENDPATH**/ ?>