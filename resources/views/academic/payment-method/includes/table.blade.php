                        ...
                        @if (isset($data['payment-method']) && $data['payment-method']->count() > 0)
                            ...
                            @foreach($data['payment-method'] as $payment_method)
                                <tr>
                                    ...
                                    <td class="hidden-480 ">
                                        <div class="btn-group">
                                            <button data-toggle="dropdown" class="btn btn-primary btn-sm dropdown-toggle {{ $payment_method->status == 'active'?"btn-info":"btn-warning" }}" >
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            <a class="btn btn-success btn-sm" href="{{ route($base_route.'.edit', ['id' => $payment_method->id]) }}">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>

                                            <a href="{{ route($base_route.'.delete', ['id' => $payment_method->id]) }}" class="btn btn-danger btn-sm bootbox-confirm">
