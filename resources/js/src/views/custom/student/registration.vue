                                ...
                                <div>
                                    ...
                                    <div>
                                        <table>
                                            ...
                                            <th>Detail</th>
                                            <th>
                                                <vs-button @click="addRow">New Academic Info</vs-button>
                                            </th>
                                            </thead>
                                            <tbody v-if="academicList.length>0">
                                            <tr v-for="(singleBox,i) in academicList">
                                                <td>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <vs-input v-model="singleBox.institution">
                                                            </vs-input>
                                                        </div>
                                                        <div class="col-md-4">Board/Training</div>
                                                        <div class="col-md-8">
                                                            <vs-input v-model="singleBox.board">
                                                            </vs-input>
                                                        </div>
                                                        <div class="col-md-4">Pass Year</div>
                                                        <div class="col-md-8">
                                                            <vs-input v-model="singleBox.pass_year">
                                                            </vs-input>
                                                        </div>
                                                        <div class="col-md-4">Symbol Number</div>
                                                        <div class="col-md-8">
                                                            <vs-input v-model="singleBox.symbol_no">
                                                            </vs-input>
                                                        </div>
                                                        <div class="col-md-4">Percentage</div>
                                                        <div class="col-md-8">
                                                            <vs-input v-model="singleBox.percentage">
                                                            </vs-input>
                                                        </div>
                                                        <div class="col-md-4">Division/Grade</div>
                                                        <div class="col-md-8">
                                                            <vs-input v-model="singleBox.division_grade">
                                                            </vs-input>
                                                        </div>
                                                        <div class="col-md-4">Major Subject</div>
                                                        <div class="col-md-8">
                                                            <vs-input v-model="singleBox.major_subject">
                                                            </vs-input>
                                                        </div>
                                                        <div class="col-md-4">Remark</div>
                                                        <div class="col-md-8">
                                                            <vs-input v-model="singleBox.remarks">
                                                            </vs-input>
                                                        </div>
