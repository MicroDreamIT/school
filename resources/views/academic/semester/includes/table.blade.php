                    ...
                    @if (isset($data['semester']) && $data['semester']->count() > 0)
                        ...
                        @foreach($data['semester'] as $semester)
                            <tr>
                                ...
                                <td class="hidden-480 ">
                                    <div class="btn-group">
                                        <button data-toggle="dropdown" class="btn btn-primary btn-sm dropdown-toggle {{ $semester->status == 'active'?"btn-info":"btn-warning" }}" >
                                ...
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons">
                                        <a class="btn btn-success btn-sm" href="{{ route($base_route.'.edit', ['id' => $semester->id]) }}">
                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                        </a>

                                        <a href="{{ route($base_route.'.delete', ['id' => $semester->id]) }}" class="btn btn-danger btn-sm">
