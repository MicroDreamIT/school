                        ...
                        @if (isset($data['student-batch']) && $data['student-batch']->count() > 0)
                            ...
                            @foreach($data['student-batch'] as $student_batch)
                                <tr>
                                    ...
                                    <td class="hidden-480 ">
                                        <div class="btn-group">
                                            <button data-toggle="dropdown" class="btn btn-primary btn-sm dropdown-toggle {{ $student_batch->status == 'active'?"btn-info":"btn-warning" }}" >
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            <a class="btn btn-success btn-sm" href="{{ route($base_route.'.edit', ['id' => $student_batch->id]) }}">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>

                                            <a href="{{ route($base_route.'.delete', ['id' => $student_batch->id]) }}" class="btn btn-danger btn-sm">
