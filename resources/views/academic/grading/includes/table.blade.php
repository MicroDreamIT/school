                ...
                @if (isset($data['grading']) && $data['grading']->count() > 0)
                    ...
                    @foreach($data['grading'] as $grading)
                        <tr>
                            ...
                            <td class="hidden-480 ">
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn btn-primary btn-sm dropdown-toggle {{ $grading->status == 'active'?"btn-info":"btn-warning" }}" >
                            ...
                            <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <a class="btn btn-sm btn-success" href="{{ route($base_route.'.edit', ['id' => $grading->id]) }}">
                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                    </a>

                                    <a href="{{ route($base_route.'.delete', ['id' => $grading->id]) }}" class="btn btn-sm btn-danger">
