        ...
        <div class="clearfix">
            {!! Form::open(['route' => $base_route.'.link','method' => 'POST', 'class' => 'form-horizontal',
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        {!! Form::select('student_link_id', [], null, ["placeholder" => "Type Student Reg.No. or Contact Number or Name...", "class" => "col-xs-12 col-sm-12 form-control", "style" => "width: 100%;"]) !!}
                ...
                @if (isset($data['guardian']) && $data['guardian']->students()->count() > 0)
                    ...
                    @foreach($data['guardian']->students()->get() as $student)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route($base_route.'.unlink', ['student' => $student->id,'guardian' => $data['guardian']->id]) }}" class="btn btn-danger btn-sm bootbox-confirm" >
