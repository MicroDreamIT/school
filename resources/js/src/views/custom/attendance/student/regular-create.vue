<template>
    <div>
        <div class="row ">
            <div class="col-md-12">
                <h2 class="pageTitle">Student Attendance
                </h2>
                <div class="mb-2">
                ...
                <vs-card>
                    <div class="row p-4">
                        <div class="mb-2 col-md-12">
                            ...
                            <router-link :to="'/attendance/student/add'">
                                <vs-button type="filled" class="smBtn">Add / Edit Student Attendance</vs-button>
                            </router-link>
                        </div>
                        <vs-divider/>
                        ...
                        <div class="row my-3 col-md-12">
                            ...
                            <div class="col-md-2">Faculty/Class</div>
                            <div class="col-md-4">
                                <v-select/>
                            </div>
                            <div class="col-md-1">Sem./Sec.</div>
                            <div class="col-md-2">
                                <v-select/>
                            </div>
                        </div>
                        <div class="row col-md-12">
                            ...
                            <p>[ Select Only if you want to filter batch-wise ]</p>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            >
                                ...
                                <template slot="thead">
                                    ...
                                    <vs-th>
                                        <vs-radio v-model="attendanceStatus"
                                                  vs-value="1"
                                                  class="radio-btn"
                                                  color="#007bff"

                                        >
                                            <p class="bg-primary">Present All</p>
                                        </vs-radio>
                                        <vs-radio v-model="attendanceStatus"
                                                  vs-value="2"
                                                  class="radio-btn "
                                        ...
                                        >
                                            <p class="bg-danger">Absent All</p>
                                        </vs-radio>
                                        <vs-radio v-model="attendanceStatus"
                                                  vs-value="3"
                                                  class="radio-btn "
                                        ...
                                        <vs-radio v-model="attendanceStatus"
                                                  ...
                                                  color="success"
                                        >
                                            <p class="bg-success">LEAVE All</p>
                                        </vs-radio>
                                        <vs-radio v-model="attendanceStatus"
                                                  vs-value="5"
                                                  class="radio-btn "
                        ...
                        <div class="col-md-12 row">
                            <vs-radio v-model="send_alert" vs-name="send_alert" vs-value="1" class="mx-2">
                                Send Attendance Alert to All
                            </vs-radio>
                            <vs-radio v-model="send_alert" vs-name="send_alert" vs-value="2" class="mx-2">
                                Send Absent Notification
                            </vs-radio>
                            <vs-radio v-model="send_alert" vs-name="send_alert" vs-value="3" class="mx-2">
                                Alert Not Required
                            </vs-radio>
                        </div>
                        <vs-divider></vs-divider>
                        <div class="col-md-12 row">
                            <vs-button color="warning my-round">Reset</vs-button>
                            <vs-button color=" my-round">Save Attendance</vs-button>
                        </div>
                    </div>
