                ...
                <section id="basic-datatable">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xs-12">
                         ...
                         <div class="col-md-12 col-xs-12">
                            <br/>
                        <?php echo Form::open(['route' => $base_route.'.history', 'method' => 'GET', 'class' => 'form-horizontal',
                'id' => 'validation-form', "enctype" => "multipart/form-data"]); ?>

                        <?php echo $__env->make($view_path.'.history.includes.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php echo Form::close(); ?>
                        ...
                        <div class="col-md-12  m-2">
                          <?php echo $__env->make($view_path.'.history.includes.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div><!-- /.col -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_new', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/viholddep/public_html/edu/resources/views/transport/user/history/index.blade.php ENDPATH**/ ?>