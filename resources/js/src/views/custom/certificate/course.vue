<template>
	<div>
		<div class="row ">
			<div class="col-md-12">
				<h2 class="pageTitle">Course Completion Certificate Manager </h2>
				<div class="p-2">
					<router-link :to="'/'">
			...
			<div class="col-md-12">
				<vs-card>
					<div class="p-2">
						<h4>Course Completion Certificate Manager</h4>
						<router-link :to="'/account/fees'">
							<vs-button type="filled" class="smBtn">
								<i class="fa fa-history" aria-hidden="true"></i>
								Bonafide Certificate  Detail
							</vs-button>
						</router-link>
					</div>
					<hr class="own-hr">
					<student-table :headers="studentHeader"
					               :tableHeader="'Course Completion Certificate Manager'"
					               :suggestText="'Course Completion Certificate Record list on table. Filter Course Completion Certificate using the filter.'"
					               :url="'/json/student/'"
