                        ...
                        @if (isset($data['circulation']) && $data['circulation']->count() > 0)
                            ...
                            @foreach($data['circulation'] as $circulation)
                                <tr>
                                    ...
                                    <td class="hidden-480 ">
                                        <div class="btn-group">
                                            <button data-toggle="dropdown" class="btn btn-primary btn-sm dropdown-toggle {{ $circulation->status == 'active'?"btn-info":"btn-warning" }}" >
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            <a class="btn-sm btn btn-success" href="{{ route($base_route.'.edit', ['id' => $circulation->id]) }}">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>

                                            {{--<a href="{{ route($base_route.'.delete', ['id' => $circulation->id]) }}" class="btn-sm btn btn-danger">
