                ...
                <vs-card>
                    ...
                    <div class="row px-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select v-model="forms.categories" class="form-control"
                                        :danger="error.categories!==undefined">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group ">
                                <label>Price </label>
                                <vs-input class="w-100" v-model="forms.price" type="number"
                                          :danger="error.price!==undefined"/>
...
<script>
    export default {
        ...
        methods: {
            ...
            getData() {
                this.$http.get('/json/library/book/' + this.$route.params.id + '/edit')
                    .then(res => {
