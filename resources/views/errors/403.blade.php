...
<head>
    ...
    <link rel="apple-touch-icon" href="{{url('/')}}/includes_new/app-assets/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="{{url('/')}}/includes_new/app-assets/images/ico/favicon.ico">
    ...
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/includes_new/app-assets/css/pages/error.css">
    <!-- END: Page CSS-->
                        ...
                        <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                            <div class="card-content">
                                <div class="card-body text-center">
                                    <img src="{{url('/')}}/includes_new/app-assets/images/pages/500.png" class="img-fluid align-self-center" alt="branding logo">
