                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li style="margin:10px">
                                                    <a href="{{ route($base_route.'.active', ['id' => $designation->id]) }}"><i class="fa fa-check" aria-hidden="true"></i> Active</a>
                                                </li>
<HR/>
                                                <li style="margin:10px">
                                                    <a href="{{ route($base_route.'.in-active', ['id' => $designation->id]) }}"><i class="fa fa-remove" aria-hidden="true"></i> In - Active</a>
                                                </li>
                                            </ul>
                                        </div>
