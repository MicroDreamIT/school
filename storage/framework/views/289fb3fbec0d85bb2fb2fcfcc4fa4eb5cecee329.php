...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#load-academicinfo-html').click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo e(route('student.academicInfo-html'), false); ?>',
                data: {
        ...
        $('select[name="guardian_link_id"]').select2({
            ...
            ajax: {
                url: '<?php echo e(route('student.guardian-name-autocomplete'), false); ?>',
                dataType: 'json',
                delay: 250,
        ...
        $('#load-guardian-html-btn').click(function () {
            ...
            if (!guardians_id)
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo e(route('student.guardianInfo-html'), false); ?>',
                    data: {
                        _token: '<?php echo e(csrf_token(), false); ?>',
                        id: guardians_id
                    },
...
</script><?php /**PATH /home/viholddep/public_html/edu/resources/views/student/registration/includes/student-comman-script.blade.php ENDPATH**/ ?>