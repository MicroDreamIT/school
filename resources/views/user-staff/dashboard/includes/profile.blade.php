...
<div class="row">
    ...
    <div class="col-md-9">
        <div class="label label-info label-xlg arrowed-right btn-primary btn-sm m-1">Welcome, {{ $data['staff']->first_name.' '.
...
<div class="row">
    <div class="space-6"></div>
    <div class="label label-info  btn-primary btn-sm m-1 label-xlg arrowed-in arrowed-right arrowed">Permanent Address</div>
    <div class="space-6"></div>
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
    ...
    <div class="space-6"></div>
    <div class="label label-info label-xlg arrowed-in arrowed-right arrowed btn-primary btn-sm m-1">Qualification Detail</div>
    <div class="space-6"></div>
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
            <div class="profile-info-name"> Qualification :  </div>
