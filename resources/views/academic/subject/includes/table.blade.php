                ...
                @if (isset($data['subject']) && $data['subject']->count() > 0)
                    ...
                    @foreach($data['subject'] as $subject)
                        <tr>
                            ...
                            <td class="hidden-480 ">
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn btn-primary btn-sm dropdown-toggle {{ $subject->status == 'active'?"btn-info":"btn-warning" }}" >
                            ...
                            <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <a class="btn btn-sm btn-success" href="{{ route($base_route.'.edit', ['id' => $subject->id]) }}">
                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                    </a>

                                    <a href="{{ route($base_route.'.delete', ['id' => $subject->id]) }}" class="btn btn-sm btn-danger">
