...
<div class="form-group row">
    ...
    <div class="col-sm-6">
        <select name="banks_id" class="chosen-select form-control" id="form-field-select-3" data-placeholder="Choose a Bank..." >
            <option value="">  </option>
            <?php $__currentLoopData = $data['banks']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($key, false); ?>"><?php echo e($bank, false); ?></option>
...
<?php /**PATH /home/viholddep/public_html/edu/resources/views/account/bank/bank-transaction/includes/form.blade.php ENDPATH**/ ?>