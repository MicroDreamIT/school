            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Route Manager</h2>
 ...
 <?php $__env->startSection('js'); ?>
  <!-- page specific plugin scripts -->
    ...
    <script>
        $(document).ready(function () {
            ...
            $('select[name="find_vehicles"]').select2({
                ...
                ajax: {
                    url: '<?php echo e(route('transport.vehicle-autocomplete'), false); ?>',
                    dataType: 'json',
                    delay: 250,
            ...
            $('#load-html-btn').click(function () {
                ...
                if (!vehicle_id)
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(route('transport.route.vehicle-html'), false); ?>',
                        data: {
    ...
    <?php echo $__env->make('includes.scripts.dataTable_scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
     ...
     <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_new', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/viholddep/public_html/edu/resources/views/transport/route/index.blade.php ENDPATH**/ ?>