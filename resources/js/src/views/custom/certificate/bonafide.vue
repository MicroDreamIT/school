<template>
	<div>
		<div class="row ">
			<div class="col-md-12">
				<h2 class="pageTitle">Bonafide Certificate Manager
			...
			<div class="col-md-12">
				<vs-card>
					...
					<student-table :headers="studentHeader"
					               :tableHeader="'Bonafide Certificate Manager'"
					               :suggestText="'Bonafide Certificate Record list on table. Filter Bonafide Certificate using the filter.'"
					               :url="'/json/student/'"
