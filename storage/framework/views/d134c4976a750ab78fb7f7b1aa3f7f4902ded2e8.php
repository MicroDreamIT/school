                ...
                <?php if(isset($data['student']) && $data['student']->count() > 0): ?>
                    ...
                    <?php $__currentLoopData = $data['student']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e(ViewHelper::getSubjectById($student->subjects_id), false); ?> </td>
                            <td>
                                <?php echo e(($student->attendance_type == 1)?"Theory":"Practical", false); ?>
...
</div><?php /**PATH /home/viholddep/public_html/edu/resources/views/attendance/subject/includes/table.blade.php ENDPATH**/ ?>