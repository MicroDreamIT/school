                        ...
                        @if (isset($data['student-status']) && $data['student-status']->count() > 0)
                            ...
                            @foreach($data['student-status'] as $student_status)
                                <tr>
                                    ...
                                    <td class="hidden-480 ">
                                        <div class="btn-group">
                                            <button data-toggle="dropdown" class="btn btn-primary btn-sm dropdown-toggle {{ $student_status->status == 'active'?"btn-info":"btn-warning" }}" >
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            <a class="btn-success btn-sm btn" href="{{ route($base_route.'.edit', ['id' => $student_status->id]) }}">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>

                                            <a href="{{ route($base_route.'.delete', ['id' => $student_status->id]) }}" class="btn-danger btn-sm btn">
