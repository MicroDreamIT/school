...
<div class="row">
    <div class="col-md-3">
        <div class="card card-blue text-md-center p-1">
    ...
    <div class="col-md-3">
        <div class="card card-yellow text-md-center p-1">
            <div class="card-block">
    ...
    <div class="col-md-3">
        <div class="card card-green text-md-center p-1">
            <div class="card-block">
    ...
    <div class="col-md-3">
        <div class="card card-red text-md-center p-1">
            <div class="card-block">
